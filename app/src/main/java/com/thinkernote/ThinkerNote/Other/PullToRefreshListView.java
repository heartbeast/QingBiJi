...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		arrowImageView = (ImageView) headView
				.findViewById(R.id.pulltorefreshhead_arrowImageView);
		arrowImageView.setMinimumWidth(70);
		arrowImageView.setMinimumHeight(50);
		progressBar = (ProgressBar) headView
				.findViewById(R.id.pulltorefreshhead_progressBar);
		tipsTextview = (TextView) headView.findViewById(R.id.pulltorefreshhead_tipsTextView);
		lastUpdatedTextView = (TextView) headView
				.findViewById(R.id.pulltorefreshhead_lastUpdatedTextView);
...
//							Log.v(TAG, "由DOne或者下拉刷新状态转变到done状态");
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_To_REFRESH:
			...
			tipsTextview.setText(R.string.pulltorefresh_listview_up_sync);
...
//			Log.v(TAG, "当前状态，下拉刷新");
		...
		case REFRESHING:
			...
			tipsTextview.setText(R.string.pulltorefresh_listview_syncing);
			lastUpdatedTextView.setVisibility(View.VISIBLE);
