...
//	private static int dismissCount = 0;
	...
	public void addActionItem(ActionItem action) {
		...
		final View container	= (View) inflater.inflate(R.layout.quickaction_item, null);
...
//            			public void run() {
//            				if(container.isPressed() || container.isFocused()
//            						|| !container.hasWindowFocus()
//            						|| dismissCount > 5){
////            					dismiss();//在此处调dismiss在android4.1以上会造成线程中更新UI的错误
////            					sendDismissMsg();//该方法处理msg不及时
//            					cancel();
//            				}else{                     	
//            					dismissCount ++;
//            				}
