...
//		}
	...
	public void onClick(View v) {
		...
		case R.id.userinfo_logout:
			TNAction.runActionAsync(TNActionType.Logout);
			break;
		}
	}
	...
	public void respondLogout(TNAction aAction) {
	...
	public void respondUpgrade(TNAction aAction) {
		if (aAction.result == TNActionResult.Finished && "SETTING".equals(aAction.inputs.get(0))) {
