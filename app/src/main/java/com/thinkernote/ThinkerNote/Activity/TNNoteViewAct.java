...
//				startActivity(TNWeiboSendAct.class, b);
	...
	protected void configView() {
		...
		if (mNote.syncState == 1) {
			if (!TNUtils.isNetWork()) {
				...
				mWebView.loadDataWithBaseURL("", getString(R.string.getingcontent),
	...
	public void respondGetNoteByNoteId(TNAction aAction) {
		if (aAction.inputs.size() == 1) //防止别的activity中的注册响应事件干扰
			return;
