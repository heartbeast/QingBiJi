...
public class TNSettingsAct extends TNActBase implements OnClickListener, OnChildClickListener, OnGroupClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TNAction.regResponder(TNActionType.VerifyEmail, this, "respondVerifyEmail");
		...
		if (requestCode == R.string.userinfo_defaultfolder) {
			if (resultCode == RESULT_OK) {
				TNAction.runActionAsync(TNActionType.SetDefaultFolderId,
						data.getLongExtra("SelectedCatId", 0));
			}
		}
	}
...
//			}
	...
	public void verifyemail() {
		...
		TNAction.runActionAsync(TNActionType.VerifyEmail);
	}
...
//				TNAction.runActionAsync(TNActionType.SetInviteCode, code);
				mProgressDialog.show();
			}
		};
	...
	public void respondVerifyEmail(TNAction aAction) {
