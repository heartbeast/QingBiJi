...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	 ...
	 */
	public void setUpdateTimeLable(String updateTimeLable) {
		if (null != mHeaderLayout) {
			mHeaderLayout.setUpdateTimeLabel(updateTimeLable);
        }
		if (null != mFooterLayout) {
			mFooterLayout.setUpdateTimeLabel(updateTimeLable);
		}
	}
...
//		mTouchSlop = ViewConfiguration.getTouchSlop();
		...
		String pullLabel = context.getString(R.string.ak_pull_to_refresh_pull_label);
		String refreshingLabel = context.getString(R.string.ak_pull_to_refresh_refreshing_label);
		String releaseLabel = context.getString(R.string.ak_pull_to_refresh_release_label);
		...
		if (mMode == MODE_PULL_UP_TO_REFRESH || mMode == MODE_BOTH) {
            mFooterLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH, releaseLabel, pullLabel, refreshingLabel,null);
